...
<div class="row mb-2">
    <div class="col-12 col-sm-3 mb-2">
        ...
        <div class="form-group">
            <label for="birthdate" class="col-sm-12 control-label">日期 of Birth</label>
            <div class="col-xs-12">
    ...
    <div class="col-12 col-sm-3 mb-2">
        <div class="form-group">
            <label for="contact" class="col-sm-12 control-label">联系方式 No.</label>
            <div class="col-xs-12">
    ...
    <div class="col-12 col-sm-4 mb-3">
        <div class="form-group">
            <label for="email" class="col-sm-12 control-label">邮箱 地址</label>
            <div class="col-xs-12">
...
<div class="row mb-2">
    ...
    <div class="col-12 col-sm-4 mb-3">
        <div class="form-group">
            <label for="confirm_password"> 确认 Password</label>
            <input type="password" id="confirm_password" name="confirm_password" placeholder="确认 your password"
